...
// sql.js browser build doesn't provide a default export;
// use dynamic import to handle CJS interop correctly
let initSqlJs: any;
...
/**
 * Lazy-load sql.js (handles missing default export in browser dist).
 */
...
export async function initMemory(): Promise<void> {
    ...
    // Create tables using WASM-generated SQL (mirrors ZeroClaw schema)
    const wasm = getWasm();
